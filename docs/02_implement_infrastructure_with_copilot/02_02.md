...
4. Prompt Copilot to generate the script
    ...
    - infra/modules/containerRegistry.bicep - Container Registry module
    - infra/modules/logAnalytics.bicep - Log Analytics module
    - infra/modules/webApp.bicep - Web App module
    - infra/modules/appServicePlan.bicep - App Service Plan module
