...
> - `AZURE_WEBAPP_NAME`
>
> Your Copilot-generated workflow may have used different variable names. Check your workflow YAML and GitHub repository settings to confirm the exact names.
...
1. From Terminal in Visual Studio Code, run the following commands:
    ...
    gh variable delete AZURE_ACR_NAME
    gh variable delete AZURE_WEBAPP_NAME
    ```
