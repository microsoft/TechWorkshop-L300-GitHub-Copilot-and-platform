...
Zava has a starting point for the Zava Storefront that is based on .NET 9. Since Zava as an organization is committed to improving developer efficiency with AI, they want to explore what Copilot can do to create issues and also automate the update to the latest .NET LTS version.
